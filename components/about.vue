	...
	<div class="container p-relative z-index-2 mt-0 mt-lg-3 mt-xl-0 pt-0 pt-md-4 pt-lg-5 pb-xl-5 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
		<div class="row">
			<div class="col-xl-7 py-4 py-xl-0">
				<img class="img-fluid" src="~/assets/img/demos/digital-agency-2/about-us/about-us-1.jpg" alt="About Us 1">
			</div>
		</div>
		...
		<div class="row justify-content-between mt-5 mt-xl-0 mb-lg-4">
			...
			<div class="col-xl-7 py-4 py-xl-0">
				<img class="img-fluid" src="~/assets/img/demos/digital-agency-2/about-us/about-us-2.jpg" alt="About Us 2">
				<ul class="custom-list list-unstyled my-3">
					<li class="font-weight-medium custom-text-4 mb-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">Porto Digital Agency Bulding, 2020</li>
				</ul>
			</div>
		</div>
	</div>
